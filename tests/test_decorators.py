...
class TestPrintingDecorator:
    """Test suite for printing_decorator function."""

    def test_printing_decorator_basic(self):
        """Test basic printing decorator functionality."""
        from auto_crud.core.crud.decorators import printing_decorator
    ...
    def test_printing_decorator_with_parameters(self):
        """Test printing decorator with function that has parameters."""
        from auto_crud.core.crud.decorators import printing_decorator
    ...
    def test_printing_decorator_with_kwargs(self):
        """Test printing decorator with function that has kwargs."""
        from auto_crud.core.crud.decorators import printing_decorator
        ...
        # The function should still work with args and kwargs
        result = test_function("arg1", "arg2", kwarg1="value1", kwarg2="value2")
        assert "arg1" in result
        assert "arg2" in result
        assert "value1" in result
        assert "value2" in result

    def test_printing_decorator_with_return_value(self):
        """Test printing decorator with function that returns different types."""
        from auto_crud.core.crud.decorators import printing_decorator
        ...
        # The function should still work and return the expected value
        result = test_function()
        assert result == {"key": "value"}

    def test_printing_decorator_with_exception(self):
        """Test printing decorator with function that raises an exception."""
        from auto_crud.core.crud.decorators import printing_decorator
    ...
    def test_printing_decorator_with_async_function(self):
        """Test printing decorator with async function."""
        from auto_crud.core.crud.decorators import printing_decorator
        ...
        # The function should still work (though we can't easily test async here)
